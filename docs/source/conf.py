...
from msha import __version__ as release
...
latex_documents = [
    (master_doc, "msha.tex", "msha Documentation", "QuantumBlack", "manual",)
]
...
man_pages = [(master_doc, "msha", "msha Documentation", [author], 1,)]
